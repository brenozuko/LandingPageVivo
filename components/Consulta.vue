<template>
  <div class="lg:flex lg:justify-center py-4 background-consulta">
    <div class="flex items-center lg:justify-center ml-6 mb-4">
      <img src="../assets/img/place.png" class="hidden lg:inline-block" alt="place icon">
